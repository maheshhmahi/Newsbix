...
import com.example.newsbix.Common.ISO8601tparse;
...
import com.example.newsbix.detailArticle;
...
class ListNewsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    CircularImageView article_image;


    public ListNewsViewHolder(@NonNull View itemView) {
        super(itemView);

        article_image = (CircularImageView)itemView.findViewById(R.id.article_image);
...
public class ListNewsAdapter extends RecyclerView.Adapter<ListNewsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ListNewsViewHolder holder, int position) {
        ...
        Date date = null;
        try{
            date = ISO8601tparse.parse(articleList.get(position).getPublishedAt());
